...
const ScreenCare = () => {
  return (
    <div className="hero lg:h-[70vh] bg-pink-50">
      <div className="hero-content grid grid-cols-2 lg:px-8">
        ...
        <div className="pr-20">
          <h1 className="text-4xl font-bold">Let us handle your screen</h1>
          <h1 className="text-4xl font-bold">
            <span className="text-secondary">Professionally.</span>
          </h1>
          <p className="py-6 text-slate-600 text-sm leading-relaxed">
