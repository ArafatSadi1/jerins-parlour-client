  ...
  return (
    <footer class="footer p-8 bg-secondary text-white">
      ...
      <div className="w-80">
        ...
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Officiis blanditiis culpa exercitationem fuga aliquid laboriosam consectetur officia aspernatur mollitia ab.</p>
