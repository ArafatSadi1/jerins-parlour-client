...
const ContactUs = () => {
  ...
  return (
    <div className="bg-pink-50 p-8">
      ...
      <form onSubmit={handleContact} className="flex flex-col justify-center items-center">
          ...
          <textarea className="textarea w-full lg:w-1/2" placeholder="Your Message"></textarea>
          <input className="btn btn-secondary my-3" type="submit" value="Send Message" />
      </form>
    </div>
  );
};
